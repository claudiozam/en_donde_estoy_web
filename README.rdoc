...
Ejemplo de Curl: curl -v -k -X GET  http://127.0.0.1:3000/api/locations/find_near_locations/30%2E5/21%2E5/all <br>
Ejemplo de URL: http://localhost:3000/api/locations/find_near_locations/20/25/all </h4>
<pre>
